...
public class LinkedAccountAdapter extends RecyclerView.Adapter<LinkedAccountAdapter.ViewHolder> {
    ...
    public LinkedAccountAdapter(Context context, List<LinkedWith> list) {
    ...
    @Override
    public LinkedAccountAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(LinkedAccountAdapter.ViewHolder holder, int position) {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            for (DataSnapshot data : dataSnapshot.getChildren()) {
                                ...
                                if (linkJoin.getId().equals(linkJoinModelList.get(position).getId())) {
                                    Constant.USER_REF.child(user.getUid()).child(LINKED_WITH).child(data.getKey()).removeValue();
